...
const HEAD_CONTENT = `
<!-- DOPAMINE CLUB STYLES -->
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@700;800&family=Plus+Jakarta+Sans:wght@400;500&family=Space+Grotesk:wght@700&family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet">
<script>
...
<style>
  ...
  .glitch-hover:hover { animation: glitch 0.2s cubic-bezier(.25, .46, .45, .94) both infinite; color: #ff4b89; }
  .neo-shadow { box-shadow: 6px 6px 0px #0D0B18; }
  .neo-shadow-sm { box-shadow: 4px 4px 0px #0D0B18; }
  .neo-shadow:hover { box-shadow: 2px 2px 0px #0D0B18; transform: translate(4px, 4px); }
  .neo-shadow:active { box-shadow: 0px 0px 0px #0D0B18; transform: translate(6px, 6px); }
  .outline-text {
      color: transparent;
      -webkit-text-stroke: 2px #e5e0f3;
  }
  .glass {
  ...
  .rare-glow:hover {
      box-shadow: 0 0 20px #abd600, 6px 6px 0 #0D0B18;
      border-color: #abd600;
  }
  .ultra-rare-glow:hover {
      box-shadow: 0 0 20px #ff4b89, 6px 6px 0 #0D0B18;
      border-color: #ff4b89;
  }
  .holographic-sticker {
      background: linear-gradient(45deg, #00dbe9, #ffb1c3, #abd600, #00dbe9);
...
files.forEach(file => {
  ...
  // Remove existing DOPAMINE CLUB STYLES if we injected it before (for idempotency)
  content = content.replace(/<!-- DOPAMINE CLUB STYLES -->[\s\S]*?<\/style>\s*/, '');
